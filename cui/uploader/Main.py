...
#        self.creator = cui.uploader.command.repository.Creator.Creator(self.data)
#        self.commiter = cui.uploader.command.repository.Commiter.Commiter(self.data)
#        self.deleter = cui.uploader.command.repository.Deleter.Deleter(self.data)
#        self.editor = cui.uploader.command.repository.Editor.Editor(self.data)
#        self.agg = cui.uploader.command.aggregate.Aggregate.Aggregate(self.data)
